...
⚠️ For testing purposes you can use the api_base_url `https://api.sdk-sandbox.closeplatform.com/` and the api_access_token `sdk-sandbox-access-token`, but this should be replaced later with the URL that Close provides to your company.
